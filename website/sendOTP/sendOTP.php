...
//if(!$to)
//{ $to=$uid; }
insert_user('$team_name','$member1_name','$member1_email','$member1_contact','$member2_name','$member2_email','$member2_contact','$member3_name','$member3_email','$member3_contact','$member4_name','$member4_email','$member4_contact',$OTP);
...
{ show('<div class="w3-container ">
<span onclick="this.parentElement.style.display="none"" class="w3-closebtn">&times;</span>
  <p>SMS Sended Sucessfully..!!</p>
  <a style="background-color: transparent; color: red;" href="verifyOTP/verifyOTP.html">Verify your OTP</a>
</div>'
.$to.'.','darkgreen');}
...
<div class="fullscreen-bg">
        <video loop muted autoplay poster="img/videoframe.jpg" class="fullscreen-bg__video">
            <source src="stock-footage-stock-market-trend-of-animation.mp4" type="video/mp4">
...
<div align="center" class="content">
    ...
    <input type="text" class="w3-input" name="email" /><br/>
    <label style="color:white">mobile:</label>
    <input type="text" class="w3-input" name="to" /><br/>
    <input type="submit" class="w3-btn w3-white w3-border w3-round" value="Send"/>
    </form><br></div>';
include('foot.php');
